...
$lang = array(
    ...
    "Unknown images format/encoding." => "Il format/encoding dell'immagine è sconosciuto.",
    "The images is too big and/or cannot be resized." => "L'immagine è troppo grande e/o non può essere rimpicciolita",
    ...
    "Loading images..." => "Caricamento immagine...",
