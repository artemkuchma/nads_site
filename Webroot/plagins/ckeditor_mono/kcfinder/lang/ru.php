...
$lang = array(
    ...
    "Unknown images format/encoding." => "Неизвестный формат изображения.",
    "The images is too big and/or cannot be resized." => "Изображение слишком большое и/или не может быть уменьшено.",
    ...
    "Loading images..." => "Загрузка изображения...",
