...
$lang = array(
    ...
    "Unknown images format/encoding." => "Αγνωστη κωδικοποίηση εικόνας.",
    "The images is too big and/or cannot be resized." => "Η εικόνα είναι πάρα πολύ μεγάλη και/η δεν μπορεί να αλλάξει μέγεθος.",
    ...
    "Loading images..." => "Η εικόνα φορτώνει...",
