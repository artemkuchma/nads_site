...
$lang = array(
    ...
    "Unknown images format/encoding." => "Невідомий формат зображення.",
    "The images is too big and/or cannot be resized." => "Зображення занадто велике і/або не може бути зменшене.",
    ...
    "Loading images..." => "Завантаження зображення...",
