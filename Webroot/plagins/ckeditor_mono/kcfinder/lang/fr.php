...
$lang = array(
    ...
    "Unknown images format/encoding." => "Format/encodage d'images inconnu.",
    "The images is too big and/or cannot be resized." => "L'images est trop grande et/ou ne peut être redimensionnée.",
    ...
    "Loading images..." => "Chargement de l'images...",
